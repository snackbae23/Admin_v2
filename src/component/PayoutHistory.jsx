...
const PayoutHistory = () => {
  ...
  const generatePDF = (invoiceData) => {
    ...
    pdf.text(`Date: ${invoiceData.date}`, 20, 50);
    pdf.text(`Requested Amount: ${invoiceData.requestedamount}`, 20, 60);
    pdf.text(`Gateway Fee: ${invoiceData.gatewayfee}`, 20, 70);
    pdf.text(`Receivable Amount: ${invoiceData.receivableamount}`, 20, 80);
    pdf.text(`Mode: ${invoiceData.mode}`, 20, 90);
    ...
    return (
      <div>
        ...
        {currentPageData()?.map((data, id) => (
          <div key={id} className="w-full flex gap-8 p-4 border-b ">
            ...
            <div className="w-[76%] flex justify-around items-center">
              ...
              <div className="w-[30%] flex pl-4">
                ...
                <button
                  ...
                  className="text-[#004AAD] text-[12px] font-bold mx-auto"
                >
                  pdf.invoice
                </button>
              </div>
    ...
    <div className="w-full h-fit flex flex-col gap-4 p-4">
      <div className="w-full flex justify-between">
        ...
        <div className="w-[40%] flex gap-4">
          <input
            type="date"
            className="focus:outline-none h-[2rem] px-3 border shadow-sm"
          />
          <div className="w-[50%] flex h-[2rem] bg-white border px-[12px] items-center gap-0 shadow-sm">
      ...
      <div className="w-full bg-[#F7F9FC] flex gap-8 p-4">
        <div className="w-[21%] flex justify-between text-[#64748B] text-[14px] font-semibold">
          <p>Merchant</p>
          <p>Date</p>
        </div>
        <div className="w-[78%] flex justify-evenly text-[#64748B] text-[14px] font-semibold">
